...
<template>
  <div v-if="loading" class="flex items-center justify-center w-full h-120 font-bold text-2xl">
    Cargando noticias...
  </div>
  <section v-else>
    <div
    ...
    >
      <h1 class="text-3xl font-bold mb-4">
        Noticias <span class="text-[#b3daff]">(ニュース)</span> Japón
        <span class="text-[#b3daff]">(日本語)</span>
      </h1>

      <div v-if="errorMsg" class="text-red-500 font-bold mb-4">
        {{ 'limite de noticias alcanzado' }}
      </div>
      ...
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 p-4 bg-white rounded-t-2xl shadow-lg"
      >
        <iframe
          class="w-full h-full rounded-xl shadow-lg"
          src="https://www.youtube.com/embed/X4LgFjy-yHY?si=TQIlKMavZrIhdG4Z"
        ...
        <iframe
          class="w-full h-full rounded-xl shadow-lg"
          src="https://www.youtube.com/embed/PGyQh5ZXxdo?si=6oMDdNuqZudrFPei"
          title="YouTube video player"
          frameborder="0"
          allow="
            accelerometer;
        ...
        <iframe
          class="w-full h-full rounded-xl shadow-lg"
          src="https://www.youtube.com/embed/XrEOQqwbKKA?si=vzFKU8SAeHEl46_s"
          title="YouTube video player"
          frameborder="0"
          allow="
            accelerometer;
        ...
        <iframe
          class="w-full h-full rounded-xl shadow-lg"
          src="https://www.youtube.com/embed/D8B2B8yPWpM?si=UeF7VFnyU-g9RbSZ"
          title="YouTube video player"
          frameborder="0"
          allow="
            accelerometer;
